...
# Try adding all the rows from the combined classes together to get percent change

sewer_percent <- sewer_data %>% 
  select(genz_swr, can_pchange:imperv_pchange) %>% 
...
# Use stringr function
sewer_percent$genz_swr = stwr(sewer_percent$genz_swr)
  
# Plot
#---------------------------------------
sewer_percent_plot <- ggplot(data = sewer_percent, aes(x = class, y = percent_change)) +
...
ggsave(here("Graphics", "percent_change_sewer.jpg"), sewer_percent_plot, width = 7.29, height = 6)
