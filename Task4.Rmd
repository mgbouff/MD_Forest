...
ggsave(here("Graphics","4_zone_change_panel.jpg"),zone_change_all, width = 8, height = 7)
...
sewer_percent <- sewer_service %>% 
  select(genz_swr, tc_percent_change:imperv_percent_change)%>% 
  pivot_longer(!genz_swr, names_to = "type", values_to = "percent")
