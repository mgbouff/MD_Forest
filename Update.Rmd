...
# Figure 32 Tree cover outside forests transitions to other land covers and uses
...
fig_30 <- ggplot(data = forest_transitions, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
  ...
  scale_fill_manual(values = transition_palette) +
  labs(
    x = "Jurisdiction",
    y = "Forest Change Transition Type (Acres)"
  ) +
  scale_y_continuous(labels = comma_format()) +
  coord_flip() +
  theme_minimal() +
