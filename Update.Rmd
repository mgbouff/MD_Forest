...
# Fragmentaion Type Palette
frag_pallette <- c(
  "Isolated Patch" = "#EE4266",
  "Edge" = "#D4F0D1",
  "Small Core" = "#6CB88F",
  "Medium Core" = "#1E895E",
  "Large Core" = "#035339"
...
state_county_merge <- full_join(county_lu_percent, state_lu_percent) %>%
  mutate(county = as.factor(county)) %>% 
...
# Plot
#---------------------------------------
fig_5 <- ggplot(data = state_county_merge, aes(x = fct_rev(county), y = percent, fill = lu)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig5_state_county_lu.jpeg"), fig_5, height = 4.5, width = 7.29)
ggsave(here("Graphics", "SvGs", "fig5_state_county_lu.svg"), fig_5, height = 4.5, width = 7.29)
...
# Plot
#---------------------------------------
fig_4 <- ggplot(data = county_tc_forest, aes(x = fct_rev(county), y = percent)) +
...
#---------------------------------------
# Plot images
ggsave(here("Graphics", "fig4_forest_percent.jpg"), fig_4)
ggsave(here("Graphics", "SVGs", "fig4_forest_percent.svg"), fig_4)

# Excel
write.xlsx(as.data.frame(county_tc_forest), file.path("Tables", file = "Fig4_Table_TC_Forest.xlsx") , sheet = "county", row.names = FALSE)

#---------------------------------------
# Group by region
#---------------------------------------
county_tc_forest_grouped <- county_tc_forest_raw %>% 
  ...
  group_by(region) %>% 
  summarise(across(c("forest_ac", "tc_out_fore","jurisdicti"), funs(sum))) %>% 
  mutate(inside_forest = forest_ac_sum/jurisdicti_sum) %>%
  mutate(outside_forest = tc_out_fore_sum/jurisdicti_sum) %>% 
  mutate(region = fct_relevel(region, "Western", "North Central", "Central", "Southern", "Upper Eastern", "Lower Eastern")) %>% 
  select(region, inside_forest, outside_forest) %>% 
  pivot_longer(!region, names_to = "type", values_to = "percent")

# Grouped Plot
#---------------------------------------
fig_4_grouped <- ggplot(data = county_tc_forest_grouped, aes(x = region, y = percent)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = c("#24693d", "#6eb663"),
                    labels = c("Inside Forest", "Outside Forest")
                      ) +
  scale_y_continuous(labels = percent) +
  labs(
    x = "Jurisdiction",
...
#---------------------------------------
# Plot images
ggsave(here("Graphics", "fig4_forest_percent_grouped.jpg"), fig_4_grouped)
ggsave(here("Graphics", "SVGs", "fig4_forest_percent_grouped.svg"), fig_4_grouped)

# Excel
write.xlsx(as.data.frame(county_tc_forest_grouped), file.path("Tables", file = "Fig4_Table_TC_Forest.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig25_state_lu_change.jpg"), fig_25, height = 5.5, width = 9)
ggsave(here("Graphics", "SVGs", "fig25_state_lu_change.svg"), fig_25, height = 5.5, width = 9)
...
# Grouped Plot
#---------------------------------------
fig_27_grouped <- ggplot(data = county_change_grouped_table, aes(x = land_cover, y = acres_change_sum)) +
  geom_col(aes(fill = land_cover)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig27_county_change_grouped.jpg"), fig_27_grouped)
ggsave(here("Graphics", "SVGs", "fig27_county_change_grouped.svg"), fig_27_grouped)

# Facet by land cover
#---------------------------------------
fig_27_grouped_lc_facet <- ggplot(data = county_change_grouped_table, aes(x = region, y = acres_change_sum)) +
...
fig_27_grouped_lc_facet

# Export
#---------------------------------------
ggsave(here("Graphics", "fig27_county_change_grouped_lc_facet.jpg"), fig_27_grouped_lc_facet)
ggsave(here("Graphics", "SVGs", "fig27_county_change_grouped_lc_facet.svg"), fig_27_grouped_lc_facet)
...
ggsave(here("Graphics", "SVGs", "fig6_plantable_area.svg"), fig_6, height = 4.5, width = 7.29)

# Excel
write.xlsx(as.data.frame(plantable_area), file.path("Tables", file = "Fig6_Plantable_Area.xlsx") , sheet = "county", row.names = FALSE)

#---------------------------------------
# Group by region
#---------------------------------------
plantable_area_grouped <- plantable_area %>% 
   mutate(region = case_when(
    county %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
    ...
    county %in% c("Wicomico", "Somerset", "Worcester") ~ "Lower Eastern")) %>% 
group_by(region) %>% 
  summarise(plantable_ac = sum(plantable_ac)) %>% 
  mutate(region = fct_relevel(region, "Western", "North Central", "Central", "Southern", "Upper Eastern", "Lower Eastern"))

# Plot Grouped by Region
#---------------------------------------
fig_6_grouped <- ggplot(data = plantable_area_grouped, aes(x = region, y = plantable_ac)) +
  geom_col(aes(fill = region)) +
  labs(
    x = "Region",
    y = "Plantable Area (Acres)"
  ) +
  scale_y_continuous(labels = comma_format()) +
  theme_minimal() +
  theme(
...
# Plot images
ggsave(here("Graphics", "fig6_plantable_area_grouped.jpg"), fig_6_grouped, height = 4.5, width = 7.29)
ggsave(here("Graphics", "SVGs", "fig6_plantable_area_grouped.svg"), fig_6_grouped, height = 4.5, width = 7.29)

# Excel
write.xlsx(as.data.frame(plantable_area_grouped), file.path("Tables", file = "Fig6_Plantable_Area.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)
...
#---------------------------------------
fig_7 <- ggplot(data = plantable_percent, aes(x = fct_rev(county), y = percent)) +
  geom_col(aes(fill = type)) +
...
ggsave(here("Graphics", "SVGs", "fig7_plantable_percent.svg"), fig_7, width = 7.29, height = 4.5)
...
#---------------------------------------
fig_7_grouped <- ggplot(data = plantable_group, aes(x = region, y = percent)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = c("#85D5A3", # Lightest Green
                               "#3EB66A", # Lighter Green
                               "#24693d")) + # Dark Green
...
#Export
#---------------------------------------
ggsave(here("Graphics", "fig7_plantable_percent_grouped.jpg"), fig_7_grouped)
ggsave(here("Graphics", "SVGs", "fig7_plantable_percent_grouped.svg"), fig_7_grouped)
...
# Plot
#---------------------------------------
fig_8 <- ggplot(data = frag_state_full, aes(x = frag_type, y = area_acres, label = area_diff)) +
...
#Export
#---------------------------------------
ggsave(here("Graphics", "fig8_state_fragmentation.jpg"), fig_8)
ggsave(here("Graphics", "SVGs", "fig8_state_fragmentation.svg"), fig_8)
...
# Plot
#---------------------------------------
fig_9 <- ggplot(data = frag_county_full, aes(x = county, y = acres_change)) +
  geom_col(aes(fill = county)) +
  scale_fill_manual(values = county_pallette) +
    labs(
...
ggsave(here("Graphics", "fig9_county_fragmentation.jpg"), fig_9, height = 4.5, width = 8)

#---------------------------------------
# County fragmentation change tables for Jessica
#---------------------------------------
fragmentation_table <- frag_county_full %>% 
  rename(fragmentation_type = frag_type)

# Group land cover change by region
fragmentation_grouped_table <- fragmentation_table %>% 
  mutate(region = case_when(
    county %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
    ...
    county %in% c("Cecil", "Kent", "Queen Anne's", "Caroline", "Talbot", "Dorchester") ~ "Upper Eastern",
    county %in% c("Wicomico", "Somerset", "Worcester") ~ "Lower Eastern")) %>% 
group_by(region, fragmentation_type) %>% 
  summarise(across(c("acres_2013", "acres_2018","acres_change"), funs(sum))) %>% 
  mutate(region = as.factor(region)) %>% 
  mutate(region = fct_relevel(region, "Western", "North Central", "Central", "Southern", "Upper Eastern", "Lower Eastern")) %>% 
  mutate(fragmentation_type = as.factor(fragmentation_type)) %>% 
  mutate(fragmentation_type = fct_relevel(fragmentation_type, "Isolated Patch", "Edge", "Small Core", "Medium Core", "Large Core"))

# Export to excel
#---------------------------------------
write.xlsx(as.data.frame(fragmentation_table), file.path("Tables", file = "Fig9_Table_Fragmentation.xlsx") , sheet = "county", row.names = FALSE)

write.xlsx(as.data.frame(fragmentation_grouped_table), file.path("Tables", file = "Fig9_Table_Fragmentation.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)
...
# Facet by region
#---------------------------------------
fig_9_region_facet <- ggplot(data = fragmentation_grouped_table, aes(x = fragmentation_type, y = acres_change_sum)) +
  geom_col(aes(fill = fragmentation_type)) +
    scale_fill_manual(values = frag_pallette) +
    labs(
      #title = "Forest Fragment Type Area Change \n from 2013 to 2018",
       y = "Area Change (acres)") +
  theme_minimal() +
...
ggsave(here("Graphics", "fig9_grouped_fragmentation_region_facet.jpg"), fig_9_region_facet, height = 4.5, width = 8)

ggsave(here("Graphics", "SVGs", "fig9_grouped_fragmentation_region_facet.svg"), fig_9_region_facet, height = 4.5, width = 8)

# Facet by fragmentation type
#---------------------------------------
fig_9_frag_facet <- ggplot(data = fragmentation_grouped_table, aes(x = region, y = acres_change_sum)) +
  geom_col(aes(fill = region)) +
    labs(
      #title = "Forest Fragment Type Area Change \n from 2013 to 2018",
       y = "Area Change (acres)") +
  theme_minimal() +
  geom_hline(aes(yintercept=0)) +
  facet_wrap(~fragmentation_type, scale = "free_y") +
  theme(
    plot.title = element_text(size = 16, face = "bold"),
    axis.title.x = element_blank(),
    axis.text.x = element_blank(),
...
ggsave(here("Graphics", "fig9_grouped_fragmentation_facet.jpg"), fig_9_frag_facet, height = 4.5, width = 8)
...
# Plot
#---------------------------------------
ggplot(data = riparian_buffer, aes(x = county, y = can_p_calc)) +
...
# Without threshold
fig_14 <- ggplot(data = riparian_buffer, aes(x = fct_rev(county), y = can_p_calc)) +
  geom_col(aes(fill = county)) +
  scale_fill_manual(values = county_pallette) +
  labs(
    x = "Jurisdiction",
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig14_riparian.jpg"), fig_16)
ggsave(here("Graphics", "SVGs", "fig14_riparian.svg"), fig_16)

#---------------------------------------
# Group by region
#---------------------------------------
riparian_grouped <- riparian_buffer %>% 
  select(county, can_a, total_a) %>% 
    mutate(region = case_when(
    county %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
...
# Plot
#---------------------------------------
fig_14_grouped <- ggplot(data = riparian_grouped, aes(x = region, y = can_p_calc)) +
  geom_col(aes(fill = region)) +
  labs(
    x = "Region",
    y = "Percent Tree Canopy \n Over Riparian Buffer Area") +
    geom_text(aes(label = label,
                vjust = -0.5),
            size = 3) +
  scale_y_continuous(labels = percent) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig14_riparian_grouped.jpg"), fig_14_grouped)
ggsave(here("Graphics", "SVGs", "fig14_riparian_grouped.svg"), fig_14_grouped)

```

Net change in the extent of forest and tree canopy outside of forest land use (acres).

```{r}
#---------------------------------------
# Net change outside forest by jurisdiction
#---------------------------------------
outside_forest <- outside_forest_raw %>% 
  pivot_longer(!county_jurisdiction_name, names_to = "type", values_to = "acres_change") %>% 
  mutate(county_jurisdiction_name = str_replace_all(county_jurisdiction_name, "Somserset", "Somerset")) %>% 
    mutate(county_jurisdiction_name = str_replace_all(county_jurisdiction_name, " County", ""))

# Plot
#---------------------------------------
fig_21 <- ggplot(data = outside_forest, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
  geom_col(aes(fill = type), position = "dodge") +
  scale_fill_manual(values = c("#24693d", "#6eb663"),
                    labels = c("Net Forest Change", "Net TC Outside Forest Change")
                     ) +
  scale_y_continuous(labels = comma_format()) +
  labs(
    x = "Jurisdiction",
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig21_outside_forest_change.jpg"), fig_21)

ggsave(here("Graphics", "SVGs", "fig21_outside_forest_change.svg"), fig_21)

#---------------------------------------
# Outside forest change tables for Jessica
#---------------------------------------
outside_forest_table <- outside_forest %>% 
  rename(county = county_jurisdiction_name) %>% 
  rename(change_type = type)
  
# Group outside forest change by region
outside_forest_grouped_table <- outside_forest_table %>% 
  mutate(region = case_when(
    county %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
    ...
    county %in% c("Cecil", "Kent", "Queen Anne's", "Caroline", "Talbot", "Dorchester") ~ "Upper Eastern",
    county %in% c("Wicomico", "Somerset", "Worcester") ~ "Lower Eastern")) %>% 
group_by(region, change_type) %>% 
  summarise(acres_change = sum(acres_change)) %>% 
  mutate(region = as.factor(region)) %>% 
  mutate(region = fct_relevel(region, "Western", "North Central", "Central", "Southern", "Upper Eastern", "Lower Eastern"))

# Export for Excel
#---------------------------------------
write.xlsx(as.data.frame(outside_forest_table), file.path("Tables", file = "Fig21_Table_Outside_Forest_Change.xlsx") , sheet = "county", row.names = FALSE)

write.xlsx(as.data.frame(outside_forest_grouped_table), file.path("Tables", file = "Fig21_Table_Outside_Forest_Change.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)

#---------------------------------------
# Net change outside forest grouped by region
#---------------------------------------
fig_21_grouped <- ggplot(data = outside_forest_grouped_table, aes(x = region, y = acres_change)) +
  geom_col(aes(fill = change_type), 
           width = 0.7,
           position = "dodge") +
    scale_fill_manual(values = c("#24693d", "#6eb663"),
                    labels = c("Net Forest Change", "Net TC Outside Forest Change")
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig21_outside_forest_change_grouped.jpg"), fig_21_grouped)
ggsave(here("Graphics", "SVGs", "fig21_outside_forest_change_grouped.svg"), fig_21_grouped)
...
# Plot
#---------------------------------------
fig_23 <- ggplot(data = development_change, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
  geom_col(aes(fill = type)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig23_development_change.jpg"), fig_23)
ggsave(here("Graphics", "SVGs", "fig23_development_change.svg"), fig_23)

#---------------------------------------
# Group by region
#---------------------------------------
development_change_grouped <- development_change %>% 
    mutate(region = case_when(
    county_jurisdiction_name %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county_jurisdiction_name %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county_jurisdiction_name %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
    county_jurisdiction_name %in% c("Calvert", "Charles", "St. Mary's") ~ "Southern",
    county_jurisdiction_name %in% c("Cecil", "Kent", "Queen Anne's", "Caroline", "Talbot", "Dorchester") ~ "Upper Eastern",
    county_jurisdiction_name %in% c("Wicomico", "Somerset", "Worcester") ~ "Lower Eastern")) %>% 
...
# Plot
#---------------------------------------
fig_23_grouped <- ggplot(data = development_change_grouped, aes(x = region, y = acres_change)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = development_palette,
                    labels=c("developed_to_forest" = "Developed to Forest", 
                             "developed_to_tree_canopy" = "Developed to Tree Canopy",
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig23_development_change_grouped.jpg"), fig_23_grouped)
ggsave(here("Graphics", "SVGs", "fig23_development_change_grouped.svg"), fig_23_grouped)
...
# Plot
#---------------------------------------
fig_24 <- ggplot(data = forest_transitions, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig24_forest_transitions.jpg"), fig_24)
ggsave(here("Graphics", "SVGs", "fig24_forest_transitions.svg"), fig_24)
...
# Plot
#---------------------------------------
fig_25 <- ggplot(data = tc_transitions, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
  geom_col(aes(fill = transition)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig25_tc_transitions.jpg"), fig_25)
ggsave(here("Graphics", "SVGs", "fig25_tc_transitions.svg"), fig_25)
...
# Plot
#---------------------------------------
fig_26 <- ggplot(data = growth_vs_change, aes(x = growth_rate, y = net_change_percent)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig26_growth_vs_change.jpg"), fig_26)
ggsave(here("Graphics", "SVGs", "fig26_growth_vs_change.svg"), fig_26)
...
# Plot
#---------------------------------------
fig_20 <- ggplot(data = timber_total, aes(x = fct_rev(county), y = tot_acres)) +
  geom_col(aes(fill = county)) +
 scale_fill_manual(values = county_pallette) +
    # scale_fill_manual(values = rep(c("#78b98f", "#453e7d", "#c1c2f5", "#1b511d", "#8fc86c", "#aedddd"),4)) +
  labs(
#    title = "Total Timber Harvest by Jurisdiction \n between 2013 and 2021",
    x = "Jurisdiction",
    y = "Timber Harvest Permits (Acres)"
  ) +
  scale_y_continuous(labels=comma_format()) +
  coord_flip() +
  theme_minimal() +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig20_timber.jpg"), fig_20)
ggsave(here("Graphics", "SVGs", "fig20_timber.svg"), fig_20)

#---------------------------------------
# Group by region
#---------------------------------------
timber_grouped <- timber_total %>% 
   mutate(region = case_when(
    county %in% c("Garrett", "Allegany", "Washington") ~ "Western",
    county %in% c("Carroll", "Baltimore", "Baltimore City", "Harford") ~ "North Central",
    county %in% c("Montgomery", "Howard", "Anne Arundel", "Prince George's", "Frederick") ~ "Central",
    ...
    county %in% c("Wicomico", "Somerset", "Worcester") ~ "Lower Eastern")) %>% 
group_by(region) %>% 
  summarise(tot_acres = sum(tot_acres)) %>% 
  mutate(region = fct_relevel(region, "Western", "North Central", "Central", "Southern", "Upper Eastern", "Lower Eastern"))

# Plot
#---------------------------------------
fig_20_grouped <- ggplot(data = timber_grouped, aes(x = region, y = tot_acres)) +
  geom_col(aes(fill = region)) +
  labs(
    x = "Region",
    y = "Timber Harvest Permits (Acres)"
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig20_timber_grouped.jpg"), fig_20_grouped)
ggsave(here("Graphics", "SVGs", "fig20_timber_grouped.svg"), fig_20_grouped)
