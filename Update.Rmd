...
growth_vs_change <- growth_vs_change_raw %>% 
  ...
  mutate(net_change_percent = net_change_percent*100) %>% 
...
fig_32 <- ggplot(data = growth_vs_change, aes(x = growth_rate, y = net_change_percent)) +
  ...
  geom_text_repel(aes(label = county_jurisdiction), size = 2.5) +
  labs(
...
ggsave(here("Graphics", "fig32_growth_vs_change.jpg"), fig_32, width = 7.29, height = 4.51)
