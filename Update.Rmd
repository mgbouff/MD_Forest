...
ggsave(here("Graphics", "SVGs", "fig10_state_fragmentation.svg"), fig_10)
...
# Plot
#---------------------------------------
fig_13 <- ggplot(data = frag_county_full, aes(x = county, y = acres_change)) +
  geom_col(aes(fill = county)) +
  scale_fill_manual(values = county_pallette) +
    labs(
...
ggsave(here("Graphics", "fig13_county_fragmentation.jpg"), fig_13, height = 4.5, width = 8)
...
# Export to excel
#---------------------------------------
# write.xlsx(as.data.frame(fragmentation_table), file.path("Tables", file = "Fig13_Table_Fragmentation.xlsx") , sheet = "county", row.names = FALSE)
# 
# write.xlsx(as.data.frame(fragmentation_grouped_table), file.path("Tables", file = "Fig13_Table_Fragmentation.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)
...
# Facet by region
#---------------------------------------
fig_13_region_facet <- ggplot(data = fragmentation_grouped_table, aes(x = fragmentation_type, y = acres_change_sum)) +
...
ggsave(here("Graphics", "fig13_grouped_fragmentation_region_facet.jpg"), fig_13_region_facet, height = 4.5, width = 8)

# Facet by fragmentation type
#---------------------------------------
fig_13_frag_facet <- ggplot(data = fragmentation_grouped_table, aes(x = region, y = acres_change_sum)) +
  geom_col(aes(fill = region)) +
    labs(
      #title = "Forest Fragment Type Area Change \n from 2013 to 2018",
       y = "Area Change (acres)") +
...
ggsave(here("Graphics", "fig13_grouped_fragmentation_facet.jpg"), fig_13_frag_facet, height = 4.5, width = 8)
...
ggsave(here("Graphics", "SVGs", "fig16_riparian.svg"), fig_16)
...
# Plot
#---------------------------------------
fig_16_grouped <- ggplot(data = riparian_grouped, aes(x = region, y = can_p_calc)) +
  geom_col(aes(fill = region)) +
  labs(
    x = "Region",
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig16_riparian_grouped.jpg"), fig_16_grouped)
ggsave(here("Graphics", "SVGs", "fig16_riparian_grouped.svg"), fig_16_grouped)
...
ggsave(here("Graphics", "SVGs", "fig28_outside_forest_change.svg"), fig_28)
...
# Export for Excel
#---------------------------------------
write.xlsx(as.data.frame(outside_forest_table), file.path("Tables", file = "Fig28_Table_Outside_Forest_Change.xlsx") , sheet = "county", row.names = FALSE)

write.xlsx(as.data.frame(outside_forest_grouped_table), file.path("Tables", file = "Fig28_Table_Outside_Forest_Change.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)

#---------------------------------------
# Net change outside forest grouped by region
#---------------------------------------
fig_28_grouped <- ggplot(data = outside_forest_grouped_table, aes(x = region, y = acres_change)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig28_outside_forest_change_grouped.jpg"), fig_28_grouped)
ggsave(here("Graphics", "SVGs", "fig28_outside_forest_change_grouped.svg"), fig_28_grouped)
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig29_development_change.jpg"), fig_29)
ggsave(here("Graphics", "SVGs", "fig29_development_change.svg"), fig_29)
...
# Plot
#---------------------------------------
fig_29_grouped <- ggplot(data = development_change_grouped, aes(x = region, y = acres_change)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = development_palette,
                    labels=c("developed_to_forest" = "Developed to Forest", 
                             "developed_to_tree_canopy" = "Developed to Tree Canopy",
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig29_development_change_grouped.jpg"), fig_29_grouped)
ggsave(here("Graphics", "SVGs", "fig29_development_change_grouped.svg"), fig_29_grouped)
...
ggsave(here("Graphics", "SVGs", "fig30_forest_transitions.svg"), fig_30)
...
ggsave(here("Graphics", "SVGs", "fig31_tc_transitions.svg"), fig_31)
...
ggsave(here("Graphics", "SVGs", "fig32_growth_vs_change.svg"), fig_32)
...
ggsave(here("Graphics", "SVGs", "fig21_timber.svg"), fig_21)
...
# Plot
#---------------------------------------
fig_21_grouped <- ggplot(data = timber_grouped, aes(x = region, y = tot_acres)) +
  geom_col(aes(fill = region)) +
  labs(
    x = "Region",
    y = "Timber Harvest Permits (Acres)"
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig21_timber_grouped.jpg"), fig_21_grouped)
ggsave(here("Graphics", "SVGs", "fig21_timber_grouped.svg"), fig_21_grouped)
