...
#---------------------------------------
fig_6_grouped <- ggplot(data = plantable_area_grouped, aes(x = fct_rev(region), y = plantable_ac)) +
...
# Export
#---------------------------------------
ggsave(here("Graphics", "fig16_riparian_grouped.jpg"), fig_16)
ggsave(here("Graphics", "SVGs", "fig16_riparian_grouped.svg"), fig_16)
