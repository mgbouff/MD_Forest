...
# Export to excel
write.xlsx(as.data.frame(fragmentation_table), file.path("Tables", file = "Fig11_Table_Fragmentation.xlsx") , sheet = "county", row.names = FALSE)

write.xlsx(as.data.frame(fragmentation_grouped_table), file.path("Tables", file = "Fig11_Table_Fragmentation.xlsx"), sheet = "region", append = TRUE, row.names = FALSE)
