...
frag_county_13_qa <- read_xls(here("Data", "New", "tab_county_13.xls"), range = cell_cols("B:Z"))

frag_county_18_qa <- read_xls(here("Data", "New", "tab_county_18.xls"), range = cell_cols("B:Z"))
