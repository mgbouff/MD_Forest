...
# Grouped Plot
#---------------------------------------
fig_4_grouped <- ggplot(data = county_tc_forest_grouped, aes(x = fct_rev(region), y = percent)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = c("#24693d", "#6eb663"),
...
#---------------------------------------
fig_7_grouped <- ggplot(data = plantable_group, aes(x = fct_rev(region), y = percent)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = c("#85D5A3", # Lightest Green
                               "#3EB66A", # Lighter Green
                               "#24693d")) + # Dark Green
