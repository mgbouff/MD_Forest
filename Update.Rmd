...
#---------------------------------------
fig_28_grouped <- ggplot(data = outside_forest_grouped_table, aes(x = fct_rev(region), y = acres_change)) +
...
# Plot
#---------------------------------------
fig_29_grouped <- ggplot(data = development_change_grouped, aes(x = fct_rev(region), y = acres_change)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = development_palette,
                    labels=c("developed_to_forest" = "Developed to Forest", 
                             "developed_to_tree_canopy" = "Developed to Tree Canopy",
