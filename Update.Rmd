...
###
fig_22_color <- ggplot(data = state_change_compare, aes(x = lu, y = tot_acres)) +
...
ggsave(here("Graphics", "fig22_color.jpg"), fig_22_color, height = 5, width = 9)

###

fig_22 <- ggplot(data = state_change_compare, aes(x = lu, y = tot_acres)) +
  ...
  annotate("text",
    ...
    annotate("text",
      ...
      annotate("text",
           x = 9, y = 3190000,
           label = "-12792", color = "red") +
  scale_fill_manual(values = c("#7fcdbb", "#009b77")) +
...
ggsave(here("Graphics", "fig22_state_lu_change.jpg"), fig_22, height = 5, width = 9)

# color by gain or loss?
