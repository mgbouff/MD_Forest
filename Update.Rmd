...
ggsave(here("Graphics", "SvGs", "fig5_state_county_lu.svg"), fig_5)
...
# Plot
#---------------------------------------
ggplot(data = outside_forest, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
...
#---------------------------------------
fig_28 <- ggplot(data = outside_forest_grouped_table, aes(x = region, y = acres_change)) +
