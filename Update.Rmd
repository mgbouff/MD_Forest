...
ggsave(here("Graphics", "fig7_plantable_percent.svg"), fig_7, width = 7.29, height = 4.5)
...
ggsave(here("Graphics", "fig7_plantable_percent_grouped.svg"), fig_7_grouped)
...
# Plot
#---------------------------------------
ggplot(data = development_change, aes(x = fct_rev(county_jurisdiction_name), y = acres_change)) +
  geom_col(aes(fill = type)) +
...
# Plot
#---------------------------------------
fig_29 <- ggplot(data = development_change_grouped, aes(x = region, y = acres_change)) +
  geom_col(aes(fill = type)) +
  scale_fill_manual(values = development_palette,
                    labels=c("developed_to_forest" = "Developed to Forest", 
                             "developed_to_tree_canopy" = "Developed to Tree Canopy",
